!-------------------------------------------------------
! this interface was written by Janhunen Jani Salomon for EDIPIC-2D particle-in-cell code
! the code and the license are available at https://github.com/PrincetonUniversity/EDIPIC-2D
!
module rng_wrapper
